...
class GithubOAuthClientTest {
    ...
    @Test
    @DisplayName("깃허브에서 사용자 정보를 가져온다.")
    void fetchUserDetails() throws JsonProcessingException {
        GithubUserDetailsResponse expectedResponse = new GithubUserDetailsResponse(
                1L,
                "login",
                "http://avatar.url",
                "alstn113@gmail.com",
        ...
        GithubUserDetailsResponse response = githubOAuthClient.fetchUserDetails(accessToken);
